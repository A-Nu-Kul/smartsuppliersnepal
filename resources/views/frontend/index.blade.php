...
<div class="s-skeleton s-skeleton--h-600 s-skeleton--bg-grey">
	...
	@foreach($banners as $banner)
		<div class="hero-slide hero-slide--1" style="background-image: url({{$banner->photo}});">
		</div>	
	@endforeach	
	</div>
</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section__text-wrap">
						<h1 class="section__heading u-c-secondary u-s-m-b-12">SHOP BY BRANDS</h1>

						<span class="section__span u-c-silver">BROWSE FAVOURITE BRAND</span>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="section__content">
			<div class="container">
				<div class="slider-fouc">
					<div class="owl-carousel product-slider" data-item="6">
					@foreach($brands as $brand)
						<div class="u-s-m-b-30">
							<div class="product-o product-o--hover-on">
							<div class="product-o__wrap">
								<a class="aspect aspect--bg-grey aspect--square u-d-block brand-slide" href="#">

									<img class="aspect__img" src="{{$brand->photo}}" alt="">
								</a>
								<div class="product-o__action-wrap">
                                                <ul class="product-o__action-list">
                                                    <li><a data-modal="modal" data-modal-id="#quick-brand-look" data-tooltip="tooltip" data-placement="top" title="Quick View"><i class="fas fa-search-plus"></i></a></li>
	...
	<div class="section__intro u-s-m-b-46">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="section__text-wrap">
						<h1 class="section__heading u-c-secondary u-s-m-b-12">SHOP BY CATEGORY</h1>
	...
	<div class="section__content">
		<div class="container">
			...
			@foreach($categories as $cat)
				<div class="col-12 col-md-4" style="display: inline-block;padding: 5%; justify-content: center">
					<a class="collection" href="#">
						<div class="aspect aspect--bg-grey aspect--square">
							<img class="aspect__img collection__img" src="{{$cat->photo}}" alt="{{$cat->title}}">
						</div>
					</a>
				</div>
			@endforeach
